// Generated by dart2js, the Dart to JavaScript compiler version: 1.23.0.
...
(function() {
  ...
  var dart = [["_foreign_helper", "dart:_foreign_helper",, H, {
    ...
    "^": "",
    getCalculation: [function($event) {
      var t1, concentrationNaOH, volumeHCl, volumeInitialNaOH, volumeNaOH, moleNaOH;
      t1 = document;
      concentrationNaOH = H.Primitives_parseDouble(H.interceptedTypeCast(t1.querySelector("#concentrationNaOH"), "$isInputElement").value, null);
    ...
    main: [function() {
      ...
      W._EventStreamSubscription$(t1._html$_target, t1._eventType, S.app__getCalculation$closure(), false, H.getTypeArgumentByIndex(t1, 0));
